...
<head>
    ...
    <title>@lang('email.next_to_subject')</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<center style="width: 100%; background: #222222;">
    ...
    <div style="max-width: 600px; margin: auto;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px;">
            ...
            <tr>
                <td bgcolor="#ffffff">
                    <img src="http://placehold.it/600x300" width="600" height="" alt="alt_text" border="0" align="center" style="width: 100%; max-width: 600px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                </td>
            </tr>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                @foreach($centerArticles as $center=>$articles)
                                    <h3>· Centro <span style="font-weight: bold;">{{ ucwords($center) }}</span></h3>
                                    <table border="1">
                                        <thead>
                                        <tr>
                                            <th>Artículo</th>
                                        ...
                                        @foreach($articles as $article)
                                            <td>{{ $article->name }}</td>
                                            <td align="center">{{ $article->storeName }}</td>
                                            <td align="center">{{ $article->location }}</td>
                                            <td align="center">{{ $article->position }}</td>
                                            <td align="center">{{ $article->expiration }}</td>
                                        @endforeach
                                        </tbody>
                                    </table>
                                @endforeach
